...
public class BiometricAuthModule extends ReactContextBaseJavaModule {
    public static final String NAME = "BiometricAuthModule";
 ...
 public void setUpAuth (){
     ReactApplicationContext context = getReactApplicationContext();
    Toast.makeText(context, "Please register a biometric credential or alternative authentication method", Toast.LENGTH_LONG).show();
